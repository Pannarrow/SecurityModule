package cn.sunline.security.anti.emulator;
...
import cn.sunline.jni.LibEmulatorJNI;
import cn.sunline.security.anti.common.Property;
import cn.sunline.security.anti.common.Utilities;
...
public class FindEmulator {
    ...
    public static boolean checkQemuBreakpoint() {
        ...
        try {
            ...
            int result = LibEmulatorJNI.qemuBkpt();
